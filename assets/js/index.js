  ...
  Carousel.prototype = {
    goLeft: function(e) {
      ...
      if (this.currentStep) {
        ...
        this.currentStep = (this.carouselSize - this.itemsAtOnce)-1;
      }
    ...
    goRight: function(e) {
      e.preventDefault();
      if (this.currentStep < ((this.carouselSize - this.itemsAtOnce) -1)) {
        ++this.currentStep;
      } else {
        this.currentStep = 0;
      }
    ...
    beResponsive: function() {
      ...
      if (winWidth >= 575 && winWidth < 992 && this.itemsAtOnce >= 2) {
        this.itemsAtOnce = 4;
      }
